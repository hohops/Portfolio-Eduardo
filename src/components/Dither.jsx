...
void main() {
  ...
  vec2 uvPixel = nps * floor(suv / nps);
  vec2 cuv = uvPixel - 0.5;
  ...
  if (enableMouseInteraction == 1) {
    ...
    float dist = length(cuv - mouseNDC);
...
export default function Dither({
    ...
    return <div ref={containerRef} className="dither-container" aria-hidden="true" />;
}
